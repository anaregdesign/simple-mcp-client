 ...
 */
import { APP_EVENT_LOG_MAX_CATEGORY_LENGTH, APP_EVENT_LOG_MAX_CONTEXT_ARRAY_ITEMS, APP_EVENT_LOG_MAX_CONTEXT_DEPTH, APP_EVENT_LOG_MAX_CONTEXT_KEYS, APP_EVENT_LOG_MAX_EVENT_NAME_LENGTH, APP_EVENT_LOG_MAX_MESSAGE_LENGTH, APP_EVENT_LOG_MAX_PATH_LENGTH, APP_EVENT_LOG_MAX_TEXT_LENGTH } from "~/lib/constants/persistence";
