...
import { SkillRegistrySection } from "~/components/client/config/skills/SkillRegistrySection";
import { SkillsSection } from "~/components/client/config/skills/SkillsSection";
